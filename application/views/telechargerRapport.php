...
<div class="container">
	...
	{	
		echo '<div class=" w3-container w3-section w3-green" id="suc">';
			...
			echo '<p>Rapport téléchargé avec succès!</p>' ;
		echo '</div>' ;
	}
	?>
	<div class="w3-card-2">
		<header class="w3-container w3-red">
			<h3 style="text-align: center">Télécharger un rapport</h3>
		</header>
		<div class="w3-container">
			<form method="POST" action="http://localhost/edoc/index.php/rapport/telecharger"><br />
