	...
	<div class="w3-card-2">
		...
		<div class="w3-container">
			<form><br />
				...
				<input type="text" name="nbreExemplaire" id="exemplaire"  class="form-control" value="Disponibilité: <?php if($livre['NOBREEXEMPLAIRE']==0){echo "livre non disponible";}else{echo "livre disponible";} ?>" readonly /><br />
				<a href="http://localhost/edoc/index.php/reservation/ajouter?titre=<?php echo $rech;?>&rech=Chercher" class="btn btn-default" style="color: black;">Fermer</a>
			</form>
		</div>
	</div>
</div>
