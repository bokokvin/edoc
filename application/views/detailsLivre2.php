	...
	<div class="w3-card-2">
		...
		<div class="w3-container">
			<form><br />
				...
				<input type="text" name="nbreExemplaire" id="exemplaire"  class="form-control" value="Dsponibilité: <?php if($livre['NOBREEXEMPLAIRE']==0){echo "livre non disponible";}else{echo "livre disponible";}?>" readonly /><br />
